...
*
*/
define('APP_BASE_URL', 'https://crm.mazajnet.com/');
...
*/
define('APP_ENC_KEY', 'f484df322b08fe9408ac21d0f8dee176');
 ...
 */
define('APP_DB_USERNAME', 'mazajnet_crm');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '45F9BGBA7O8RZ88WD5');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'mazajnet_crm');
