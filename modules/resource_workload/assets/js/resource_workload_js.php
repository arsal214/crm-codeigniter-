...
"use strict";
  ...
  $('.fc-wl-day-button').on('click', function () {

    $('input[name="workload_type"]').val('day');
    $('.fc-wl-day-button').addClass('active');
    $('.fc-wl-week-button').removeClass('active');
    $('.fc-wl-month-button').removeClass('active');

    get_data_workload();
  });

  $('.fc-wl-week-button').on('click', function () {

    $('input[name="workload_type"]').val('week');
    $('.fc-wl-day-button').removeClass('active');
    $('.fc-wl-week-button').addClass('active');
    $('.fc-wl-month-button').removeClass('active');

    get_data_workload();
  });

  $('.fc-wl-month-button').on('click', function () {

    $('input[name="workload_type"]').val('month');
    $('.fc-wl-day-button').removeClass('active');
    $('.fc-wl-week-button').removeClass('active');
    $('.fc-wl-month-button').addClass('active');
...
function get_data_workload() {
  ...
  data.from_date = $('input[name="from_date"]').val();
  data.to_date = $('input[name="to_date"]').val();
  data.task_status = $('select[name="task_status"]').val();
  ...
  <?php if($type == 'workload'){ ?>
    data.workload_type = $('input[name="workload_type"]').val();
...
function init_chart(data) {
  ...
  data_filter.task_status = $('select[name="task_status"]').val();
