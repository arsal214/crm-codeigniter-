<div class="mx-auto mt-3 btn-group fc" role="group">
    <button type="button" class="button-text-transform fc-wl-day-button btn btn-sm btn-default active"><?php echo _l('mrp_day') ?></button>
    <button type="button" class="button-text-transform fc-wl-week-button btn btn-sm btn-default"><?php echo _l('mrp_week') ?></button>
    <button type="button" class="button-text-transform fc-wl-month-button btn btn-sm btn-default"><?php echo _l('mrp_month') ?></button>
    <?php echo form_hidden('workload_type', 'day'); ?>
</div>
<br>
<br>
