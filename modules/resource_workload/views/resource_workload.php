              ...
              <div class="panel-body">
                ...
                <div class="row">
                  <div id="kanban-params">
                    <div class="col-md-4 <?php if($type == 'capacity'){echo 'hide';} ?>">
                    ...
                    <div class="col-md-3 <?php if($type == 'capacity'){echo 'hide';} ?>">
                    ...
                    <div class="col-md-3 <?php if($type == 'capacity'){echo 'hide';} ?>">
                        <?php $task_status = [];
                        $task_status[] = ['id' => '1', 'name' => _l('task_status_1')];
                        $task_status[] = ['id' => '2', 'name' => _l('task_status_2')];
                        $task_status[] = ['id' => '3', 'name' => _l('task_status_3')];
                        $task_status[] = ['id' => '4', 'name' => _l('task_status_4')];
                        $task_status[] = ['id' => '5', 'name' => _l('task_status_5')];
                        echo render_select('task_status', $task_status, array('id', 'name'), 'sw_task_status', '', array('multiple' => true, 'data-actions-box' => true), array(), '', '', false); ?>
                    </div>
