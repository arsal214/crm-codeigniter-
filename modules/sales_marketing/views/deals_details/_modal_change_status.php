<?php
if (!empty($status)) { ?>
    <?php echo form_open(base_url('admin/'.SAM_MODULE.'/changedStatus/' . $id . '/' . $status), array('id' => 'deals_notes_form', 'enctype' => 'multipart/form-data', 'data-parsley-validate' => '', 'role' => 'form')); ?>
