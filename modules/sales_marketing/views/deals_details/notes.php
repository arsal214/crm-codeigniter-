...
<?php echo form_open(base_url('admin/'.SAM_MODULE.'/save_deals_notes/' . $id), array('id' => 'deals_notes_form', 'enctype' => 'multipart/form-data', 'data-parsley-validate' => '', 'role' => 'form')); ?>
