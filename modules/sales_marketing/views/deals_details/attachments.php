<?php echo form_open('admin/'.SAM_MODULE.'/add_deals_attachment', ['class' => 'dropzone mtop15 mbot15', 'id' => 'deals-attachment-upload']); ?>
...
<?php if (get_option('dropbox_app_key') != '') { ?>
    ...
    <div class=" pull-left">
        <?php if (count($deals_details->attachments) > 0) { ?>
            <a href="<?php echo admin_url(SAM_MODULE.'/download_files/' . $deals_details->id); ?>" class="bold">
...
if (count($deals_details->attachments) > 0) { ?>
    <div class="mtop20" id="deals_attachments">
        <?php $this->load->view(SAM_MODULE.'/deals_details/deals_attachments_template', ['attachments' => $deals_details->attachments]); ?>
    </div>
<?php } ?>
