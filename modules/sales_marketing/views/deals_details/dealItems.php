<?php
$itemType = 'sam';
$sales_info = get_sam_result('tbl_sam_items', array('deals_id' => $id));
$all_tax_info = array();
            ...
            foreach ($sales_info as $key => $v_item) :
                ...
                <tr class="sortable item" data-item-id="" id="<?= $v_item->items_id ?>">
                    ...
                    <td><?php
                        ...
                        ?></td>
                    <td><?= sam_display_money($v_item->total_cost) ?></td>
                    <td>
                        <a href="<?= base_url('admin/'.SAM_MODULE.'/manuallyItems/' . $id . '/' . $v_item->items_id) ?>" class="btn btn-xs btn-primary" data-placement="top" data-toggle="modal" data-target="#myModal">
                            <i class="fa fa-edit"></i></a>
                        <a href="<?= base_url('admin/'.SAM_MODULE.'/delete_items/' . $v_item->items_id . '/' . $id) ?>" class="btn btn-xs btn-danger">
        ...
        <div class="col-sm-4 pv">
            <div class="clearfix">
                ...
                <p class="pull-right mr">
                    <?= $sub_total ? sam_display_money($sub_total) : '0.00' ?>
                </p>
            </div>
            ...
            <div class="clearfix">
                ...
                <p class="pull-right mr">
                    <?= sam_display_money($total, sam_default_currency()) ?>
                </p>
            </div>
        </div>
    </div>
