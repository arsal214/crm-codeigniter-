<div class="panel panel-custom">
    ...
    <div class="modal-body wrap-modal wrap">
        <?php echo form_open(base_url('admin/'.SAM_MODULE.'/add_insert_items/' . $id), array('id' => 'from_items', 'enctype' => 'multipart/form-data', 'data-parsley-validate' => '', 'role' => 'form')); ?>
                        ...
                        if (!empty($v_saved_items)) {
                            foreach ($v_saved_items as $v_item) {
                                ...
                                <tr>
                                    ...
                                    <td><?= sam_display_money($v_item->unit_cost) ?></td>
                                    <td><?php
