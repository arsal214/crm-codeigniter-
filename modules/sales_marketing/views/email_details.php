                ...
                if (!empty($details->attach_file)) {
                    ...
                    if (!empty($uploaded_file)) {
                        foreach ($uploaded_file as $attachment) {
                            $attachment_url = site_url('admin/'.SAM_MODULE.'/file_download/deals_email/' . $details->id . '/' . $attachment->file_name);
                            ...
                            if (is_admin()) {
                                $data .= '<a href="' . base_url() . 'admin/'.SAM_MODULE.'/delete_email_attachment/' . $details->id . '/' . $details->file_name . '" class="text-danger" "><i class="fa fa fa-times"></i></a>';
                            }
                            $data .= '</div>';
