        ...
        <tbody>
            ...
            <tr class="payment">
                <td><?php echo e($payment['paymentid']); ?>
                    <?php echo icon_btn(SAM_MODULE.'/payments/pdf/' . $payment['paymentid'], 'fa-regular fa-file-pdf', 'btn-default pull-right'); ?>
                </td>
    ...
    echo ' - ' . $payment['paymentmethod'];
                ...
                <td>
                    <div class="tw-flex tw-items-center tw-space-x-3">
                        <a href="<?php echo admin_url(SAM_MODULE.'/payments/payment/' . $payment['paymentid']); ?>"
                            class="tw-text-neutral-500 hover:tw-text-neutral-700 focus:tw-text-neutral-700">
                            <i class="fa-regular fa-pen-to-square fa-lg"></i>
                        </a>
                        <?php if (staff_can('delete',  'payments')) { ?>
                        <a href="<?php echo admin_url(SAM_MODULE.'/invoices/delete_payment/' . $payment['paymentid'] . '/' . $payment['invoiceid']); ?>"
