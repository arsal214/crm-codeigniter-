            ...
            <div class="col-md-12">
                <div class="tw-mb-2 sm:tw-mb-4">
                    <a href="#" onclick="new_stage(); return false;" class="btn btn-primary">
                        ...
                        <?php echo 'New Stage'; //echo _l('new_stage'); ?>
                    </a>
                </div>
                <div class="panel_s">
                    <div class="panel-body panel-table-full">
                        <?php if (count($stages) > 0) { ?>
                            <table class="table dt-table" data-order-col="3" data-order-type="asc">
                                ...
                                <th><?php echo 'Stages'; //echo _l('deals_stages_table_name'); ?></th>
                                <th><?php echo 'Pipeline'; //echo _l('deals_pipelines_table_name'); ?></th>
                                <th><?php echo 'Order'; //echo _l('leads_status_add_edit_order'); ?></th>
                                ...
                                <?php foreach ($stages as $stage) { ?>
                                    <tr>
                                        ...
                                        <td><a href="#"
                                            ...
                                            <?php 
                                            //echo _l('deals_table_total', total_rows(db_prefix() . '_deals', ['stage_id' => $stage['stage_id']])); 
                                            echo _l('Total', total_rows(db_prefix() . '_sam', ['stage_id' => $stage['stage_id']])); 
                                            ?>
                                        </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="tw-flex tw-items-center tw-space-x-3">
                                                ...
                                                <a href="<?php echo admin_url('sales_marketing/delete_stages/' . $stage['stage_id']); ?>"
...
<div class="modal fade" id="stage" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('sales_marketing/stage')); ?>
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">
                    <span class="edit-title"><?php echo 'Edit Stage'; //echo _l('edit_stage'); ?></span>
                    <span class="add-title"><?php echo 'New Stage'; //echo _l('new_stage'); ?></span>
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php 
                        //echo render_input('name', 'deals_stage_add_edit_name'); 
                        echo render_input('name', 'Stage Name'); 
                        ?>
                        <?php 
                        //echo render_select('pipeline_id', $pipelines, ['pipeline_id', 'pipeline_name'], _l('pipelines')); 
                        echo render_select('pipeline_id', $pipelines, ['pipeline_id', 'pipeline_name'], 'Pipeline'); 
                        ?>
                        <?php echo render_input('stage_order', 'leads_status_add_edit_order', total_rows(db_prefix() . '_sam_stages') + 1, 'number'); ?>
                    </div>
                </div>
