        ...
        <div class="row">
            <div class="col-md-5">
                <h4 class="tw-mt-0 tw-font-semibold tw-text-lg tw-text-neutral-700">
                    ...
                    <a href="<?php echo admin_url(SAM_MODULE.'/invoices/#' . $payment->invoiceid); ?>">
                    ...
                    <div class="tw-self-start">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li class="hidden-xs">
                                    <a
                                        href="<?php echo admin_url(SAM_MODULE.'/payments/pdf/' . $payment->paymentid . '?output_type=I'); ?>">
                                        <?php echo _l('view_pdf'); ?>
                                    </a>
                                </li>
                                <li class="hidden-xs">
                                    <a href="<?php echo admin_url(SAM_MODULE.'/payments/pdf/' . $payment->paymentid . '?output_type=I'); ?>"
                                        target="_blank">
                                        <?php echo _l('view_pdf_in_new_window'); ?>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo admin_url(SAM_MODULE.'/payments/pdf/' . $payment->paymentid); ?>">
                                        <?php echo _l('download'); ?>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo admin_url(SAM_MODULE.'/payments/pdf/' . $payment->paymentid . '?print=true'); ?>"
                                        target="_blank">
                                        <?php echo _l('print'); ?>
                                    </a>
                                </li>
                        ...
                        <a href="<?php echo admin_url(SAM_MODULE.'/payments/delete/' . $payment->paymentid .'/'. $payment->sam_id); ?>"
...
<?php $this->load->view(SAM_MODULE.'/payments/send_to_client'); ?>
<?php init_tail(); ?>
<script>
$(function() {
