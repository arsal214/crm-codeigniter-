        ...
        <div class="row">
         ...
         if (isset($proposal)) {
            ...
            if (isset($proposal) || ($this->input->get('rel_id') && $this->input->get('rel_type'))) {
                ...
                if(isset($sam_data)){
                    $rel_id = $sam_data->rel_id;    
                    $rel_type = trim($sam_data->rel_type);    
                }
            }
            ?>
            <?php
         ...
         ?>
            ...
            <div class="col-md-12">
                <h4
                    ...
                    <span>
                        <?php echo e(isset($proposal) ? format_proposal_number($proposal->id) : _l('sam_new_proposal')); ?>
                    </span>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6 border-right">
                                ...
                                <?php echo render_input('subject', 'sam_proposal_subject', $value, 'text', $attrs); ?>
                                ...
                                <div class="form-group select-placeholder<?php if($rel_id == ''){ echo ' hide';} ?> " id="rel_id_wrapper">
                                    <label for="rel_id"><span class="rel_id_label"><?=_l('proposal_for_customer')?></span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <?php echo render_date_input('date', 'sam_proposal_date', $value); ?>
                                    </div>
                                    <div class="col-md-6">
                                        <?php
                                        $value = '';
                                        ...
                                        echo render_date_input('open_till', 'sam_proposal_opentill', $value); ?>
                                    </div>
                                </div>
                                <?php
                               $selected      = '';
                               ...
                               ?>
                                ...
                                <div class="form-group no-mbot">
                                    ...
                                    <input type="text" class="tagsinput" id="tags" name="tags"
                                        value="<?php echo(isset($proposal) ? prep_tags_input(get_tags_in($proposal->id, 'sam_proposal')) : ''); ?>"
                                        data-role="tagsinput">
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group select-placeholder">
                                            <label for="status"
                                                class="control-label"><?php echo _l('proposal_status'); ?>
                                            </label>
                                            <?php
                                            $disabled = '';
                                            if (isset($proposal)) {
