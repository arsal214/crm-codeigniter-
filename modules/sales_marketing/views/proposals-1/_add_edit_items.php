                ...
                <?php if (isset($estimate) || isset($add_items)) {
                         ...
                         foreach ($add_items as $item) {
                             ...
                             if (!isset($is_proposal)) {
                                 $estimate_item_taxes = sam_get_estimate_item_taxes($item['id']);
                             } else {
                                 $estimate_item_taxes = sam_get_proposal_item_taxes($item['id']);
                             }
                             if ($item['id'] == 0) {
                             ...
                             $table_row .= '<td class="taxrate">' . $this->sam_proposals_model->get_taxes_dropdown_template('' . $items_indicator . '[' . $i . '][taxname][]', $estimate_item_taxes, (isset($is_proposal) ? 'sam_proposal' : 'sam_estimate'), $item['id'], true, $manual) . '</td>';
