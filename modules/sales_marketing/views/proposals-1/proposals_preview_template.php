                ...
                <div class="panel-body">
                        ...
                        <div class="horizontal-tabs">
                            <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                                    ...
                                    <a href="#tab_comments" onclick="get_proposal_comments(); return false;"
                                        ...
                                        <?php
                                          ...
                                          $total_comments = total_rows(
                                              db_prefix() . '_sam_proposal_comments',
                                              [
                                ...
                                <li role="presentation" class="tab-separator">
                                    <a href="#tab_notes"
                                        onclick="get_sales_notes(<?php echo e($proposal->id); ?>,'<?=SAM_MODULE?>/proposals/'); return false"
                                ...
                                <li role="presentation" style="display:none" data-toggle="tooltip" title="<?php echo _l('emails_tracking'); ?>"
                                    class="tab-separator">
                                ...
                                <li role="presentation" style="display:none" data-toggle="tooltip" data-title="<?php echo _l('view_tracking'); ?>"
                                    class="tab-separator">
                                ...
                                <li role="presentation" style="display:none" data-toggle="tooltip" data-title="<?php echo _l('toggle_full_view'); ?>"
                    ...
                    <div class="row mtop20">
                        ...
                        <div class="col-md-9 text-right _buttons proposal_buttons">
                            ...
                            <a href="<?php echo admin_url(SAM_MODULE.'/proposals/proposal/' . $proposal->rec_id .'/'. $proposal->id); ?>" data-placement="left"
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li class="hidden-xs"><a
                                            href="<?php echo admin_url(SAM_MODULE.'/proposals/pdf/' . $proposal->id . '?output_type=I'); ?>"><?php echo _l('view_pdf'); ?></a>
                                    </li>
                                    <li class="hidden-xs"><a
                                            href="<?php echo admin_url(SAM_MODULE.'/proposals/pdf/' . $proposal->id . '?output_type=I'); ?>"
                                            target="_blank"><?php echo _l('view_pdf_in_new_window'); ?></a></li>
                                    <li><a
                                            href="<?php echo admin_url(SAM_MODULE.'/proposals/pdf/' . $proposal->id); ?>"><?php echo _l('download'); ?></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo admin_url(SAM_MODULE.'/proposals/pdf/' . $proposal->id . '?print=true'); ?>"
                                            target="_blank">
                                            <?php echo _l('print'); ?>
                                        </a>
                                    </li>
                            ...
                            <div class="btn-group " style="">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li>
                                        <a href="<?php echo site_url(SAM_MODULE.'/proposal/proposal_view/' . $proposal->rec_id .'/'. $proposal->id . '/' . $proposal->hash); ?>"
...
<!--                                    <li>
                                    ...
                                    <li>
                                        <a
                                            href="<?php echo admin_url() . SAM_MODULE. '/proposals/copy/' . $proposal->id; ?>"><?php echo _l('proposal_copy'); ?></a>
                                    </li>
                                    <?php } ?>
                                    ...
                                    <li>
                                        <a
                                            href="<?php echo admin_url() . SAM_MODULE. '/proposals/mark_action_status/' . $status . '/' . $proposal->id .'/'.$proposal->rec_id; ?>"><?php echo e(_l('proposal_mark_as', format_proposal_status($status, '', false))); ?></a>
                                    </li>
                                    <?php
                                 }
                                            }
                                    ...
                                    <li>
                                        <a href="<?php echo admin_url(SAM_MODULE.'/proposals/clear_signature/' .$proposal->rec_id .'/'. $proposal->id); ?>"
                                            class="_delete">
                                    ...
                                    ?>
                                    <li>
                                        <a href="<?php echo admin_url() . SAM_MODULE. '/proposals/delete/' .$proposal->rec_id .'/'. $proposal->id; ?>"
                        ...
                        <div class="col-md-12">
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="tab_proposal">
                                    <div class="row mtop10">
                                        ...
                                        <div class="col-md-12">
                                          ...
                                          '<b>' . $proposal->acceptance_ip . '</b>' . (is_admin() ? '&nbsp;<a href="' . admin_url(SAM_MODULE.'/proposals/clear_acceptance_info/' .$proposal->rec_id .'/'. $proposal->id) . '" class="_delete text-muted" data-toggle="tooltip" data-title="' . _l('clear_this_information') . '"><i class="fa fa-remove"></i></a>' : ''),
                                          ]); ?>
                                            </div>
                                        </div>
                                        <?php }
                                 if ($proposal->project_id) { ?>
                                        ...
                                        <div class="col-md-6">
                                          ...
                                          ?>
                                                <a href="<?php echo admin_url(SAM_MODULE.'/proposals/proposal/' . $proposal->rec_id .'/'. $proposal->id); ?>">
                                            ...
                                            <h5 class="bold mbot15 font-medium"><a
                                                    href="<?php echo admin_url(SAM_MODULE.'/proposals/proposal/' . $proposal->rec_id .'/'. $proposal->id); ?>"><?php echo e($proposal->subject); ?></a>
                                            </h5>
                                ...
                                <div role="tabpanel" class="tab-pane" id="tab_notes">
                                    <div class="row proposal-notes mtop15">
                                        <div class="col-md-12">
                                            <div id="proposal-notes"></div>
                                            <div class="clearfix"></div>
                                            <textarea name="content" id="description" rows="4"
                                                class="form-control mtop15 proposal-notes"></textarea>
                                            <button type="button" class="btn btn-primary mtop10 pull-right"
                                                onclick="add_proposal_notes();"><?php echo _l('estimate_add_note'); ?></button>
                                        </div>
                                    </div>
                             <!--       <?php //echo form_open(admin_url(SAM_MODULE.'/proposals/add_note/' . $proposal->id), ['id' => 'sales-notes', 'class' => 'proposal-notes-form']); ?>
...
function save_proposal_content(manual) {
  ...
  $.post(admin_url + "<?=SAM_MODULE?>/proposals/save_proposal_data", data)
...
function add_proposal_comment() {
    ...
    if ("" != e) {
        ...
        $.post(admin_url + "<?=SAM_MODULE?>/proposals/add_proposal_comment", t).done((function(e) {
            e = JSON.parse(e),
...
function get_proposal_comments() {
    "undefined" != typeof proposal_id && requestGet("<?=SAM_MODULE?>/proposals/get_proposal_comments/" + proposal_id).done((function(e) {
...
function remove_proposal_comment(e) {
    confirm_delete() && requestGetJSON("<?=SAM_MODULE?>/proposals/remove_comment/" + e).done((function(t) {
...
function edit_proposal_comment(e) {
    ...
    "" != t && ($.post(admin_url + "<?=SAM_MODULE?>/proposals/edit_comment/" + e, {
        content: t
    }).done((function(a) {
...
function edit_note(e) {
    ...
    "" !== t && ($.post(admin_url + "<?=SAM_MODULE?>/proposals/edit_note/" + e, {
        description: t
    }).done((function(t) {
...
function delete_sales_note(e, t) {
    confirm_delete() && requestGetJSON("<?=SAM_MODULE?>/proposals/delete_note/" + t).done((function(t) {
...
function add_proposal_notes() {
    var e = $("#description").val();
    if ("" != e) {
        var t = {};
        t.description = e,
        t.rel_id = proposal_id,
        $("body").append('<div class="dt-loader"></div>'),
        $.post(admin_url + "<?=SAM_MODULE?>/proposals/add_note/"+proposal_id, t).done((function(e) {
            e = JSON.parse(e), 
            $("body").find(".dt-loader").remove(),
            ($("#description").val(""),
            get_sales_notes(proposal_id,'<?=SAM_MODULE?>/proposals'))
        }
        ))
    }
}
