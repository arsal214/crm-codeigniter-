...
if(isset($sam_rec[0])){
    $sam_rec  = $sam_rec[0];
    if(isset($sam_rec['rel_type']) && $sam_rec['rel_type']=='customer')
...
<div class="panel_s invoice accounting-template">
            ...
            <div class="col-md-6">
                <div class="f_client_id">
                    <div class="form-group select-placeholder">
                        ...
                        <select id="clientid" name="clientid" data-live-search="true" data-width="100%" class="selectpicker" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-4">
                <?php $this->load->view(SAM_MODULE.'/invoices/item_select'); ?>
            </div>
...
<div class="btn-bottom-toolbar text-right" style="display:block">
    <?php if (!isset($invoice)) { ?>
