                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="label label-default mleft5 customer-group-list pointer">
                                                    <a href="https://crm.mazajnet.com/admin/clients/client/<?php echo $customer['userid']; ?>" target="_blank">
                                                        <?php echo $customer['company']; ?>
                                                    </a>
                                                </span>
                                            </td>
                                            <td><?php echo $customer['phonenumber']; ?></td>
                                            <td><?php echo $customer['group_names']; ?></td>
                                            <td><?php echo $customer['currency_symbol']; ?></td>
                                            <td><?php echo $customer['city']; ?></td>
                                            <td><?php echo $customer['country_short_name']; ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
                            </table>
                        <?php } else { ?>
                            <p class="no-margin"><?php echo _l('CUSTOMER NOT FOUND'); ?></p>
                        <?php } ?>
                    </div>
                </div>
            </div>
