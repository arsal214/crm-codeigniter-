        ...
        <div class="row">
            <div class="col-md-12">
                <div class="_buttons tw-mb-2 sm:tw-mb-4">
                    <?php if (has_permission('sam', '', 'create')) { ?>
                        <a href="<?php echo admin_url('sales_marketing/new_sam'); ?>"
                    ...
                    <div class="row">
                        <div class="col-sm-5 ">
                            ...
                            <a href="<?php echo admin_url('sales_marketing/switch_kanban/' . $switch_kanban); ?>"
                        ...
                        <?php if ($this->session->userdata('sam_kanban_view') == 'true') { ?>
                            <div class="tw-flex ">
                        ...
                        <?php echo form_hidden('sort', (get_option('default_sam_kanban_sort') != '' ? get_option('default_sam_kanban_sort_type') : '')); ?>
                    </div>
                                        ...
                                        <div class="panel-body pl-sm pr-sm pt-sm pb0 text-center">
                                            <h3 class="mt0 mb0">
                                                <strong>
                                                    ...
                                                    $total_deals = $this->db->select_sum('deal_value')->get('tbl_sam')->row();
                                                    echo sam_display_money($total_deals->deal_value);
                                                    ?>
                                                </strong>
                                            </h3>
                                        ...
                                        <div class="panel-body pl-sm pr-sm pt-sm pb0 text-center">
                                            <h3 class="mt0 mb0">
                                                <strong>
                                                    ...
                                                    $this_months_deals = $this->db->where($where)->select_sum('deal_value')->get('tbl_sam')->row();
                                                    echo sam_display_money($this_months_deals->deal_value);
                                                    ?>
                                                </strong>
                                    ...
                                    <div class="panel widget">
                                        <div class="panel-body pl-sm pr-sm pt-sm pb0 text-center">
                                            <h3 class="mt0 mb0">
                                                ...
                                                $this_weeks_deals = $this->db->where($where)->select_sum('deal_value')->get('tbl_sam')->row();
                                                echo sam_display_money($this_weeks_deals->deal_value);
                                                ?>
                                            </h3>
                                    ...
                                    <div class="panel widget">
                                        <div class="panel-body pl-sm pr-sm pt-sm pb0 text-center">
                                            <h3 class="mt0 mb0">
                                                ...
                                                $last_30_days_deals = $this->db->where($where)->select_sum('deal_value')->get('tbl_sam')->row();
                                                echo sam_display_money($last_30_days_deals->deal_value);
                                                ?>
                                            </h3>
                                ...
                                <div class="active kan-ban-tab" id="kan-ban-tab" style="overflow:auto;">
                                    <div class="kanban-leads-sort">
                                        ...
                                        <a href="#" onclick="deals_kanban_sort('created_at'); return false"
                                           class="dateadded">
                                            <?php if (get_option('default_sam_kanban_sort') == 'created_at') {
                                                echo '<i class="kanban-sort-icon fa fa-sort-amount-' . strtolower(get_option('default_sam_kanban_sort_type')) . '"></i> ';
                                            } ?><?php echo _l('leads_sort_by_datecreated'); ?>
                                        </a>
                                        |
                                        <a href="#" onclick="deals_kanban_sort('dealorder');return false;"
                                           class="leadorder">
                                            <?php if (get_option('default_sam_kanban_sort') == 'dealorder') {
                                                echo '<i class="kanban-sort-icon fa fa-sort-amount-' . strtolower(get_option('default_sam_kanban_sort_type')) . '"></i> ';
                                        ...
                                        <a href="#" onclick="deals_kanban_sort('deal_value');return false;"
                                           class="lastcontact">
                                            <?php if (get_option('default_sam_kanban_sort') == 'deal_value') {
                                                echo '<i class="kanban-sort-icon fa fa-sort-amount-' . strtolower(get_option('default_sam_kanban_sort_type')) . '"></i> ';
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 leads-filter-column">
                                                <?php
                                                    if(is_admin()){ 
                                                        echo render_select('deal_owner', $staff, ['staffid', ['firstname', 'lastname']], '', '', ['data-width' => '100%', 'data-none-selected-text' => _l('deal_owner')], [], 'no-mbot'); 
                                                    }
                                                    else{
                                                        //echo render_select('deal_owner', $staff, ['staffid', ['firstname', 'lastname']], '', '', ['data-width' => '100%', 'data-none-selected-text' => _l('deal_owner')], [], 'no-mbot');    
                                                        echo '<select id="deal_owner" name="deal_owner" class="selectpicker" data-width="100%" data-none-selected-text="Deal Owner" data-live-search="true" tabindex="-98">
                                          ...
                                          <div class="col-md-2 leads-filter-column">
                                                    <?php
                                                        $deal_statuses = $this->db->get('tbl_sam_status')->result_array();
                                                        $selected_deal_status = $this->input->get('deal_status');  // Get deal_status from URL
                                                        echo render_select('deal_status', $deal_statuses, ['status_id', 'status_name'], '', $selected_deal_status, 
                                                            ['data-width' => '100%', 'data-none-selected-text' => _l('Deal Status')], [], 'no-mbot');
                                                    ?>
                                                </div> 
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped DataTables " id="DataTables" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <th><?= _l('status') ?></th>
                                                    <th><?= _l('Deal Status') ?></th> 
                                                    <?php
                                                    $custom_fields = get_table_custom_fields('sam');
                                            ...
                                            <script type="text/javascript">
                                                list = "<?= admin_url() ?>sales_marketing/dealsList/<?=$sam_ids?>";
                                            </script>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    function deals_kanban_update(ui, object) {
        ...
        setTimeout(function () {
            $.post(admin_url + "sales_marketing/update_deal_satges", data).done(function (
                response
            ) {
    ...
    function init_deals_stages_sortable() {
        $("#kan-ban").sortable({
            ...
            update: function (event, ui) {
                ...
                $.post(admin_url + "sales_marketing/update_stage_order", data);
            },
        });
    }
