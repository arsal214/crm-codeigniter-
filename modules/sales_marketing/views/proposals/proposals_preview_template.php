    ...
    <div class="panel-body">
        ...
        <div class="row mtop20">
            ...
            <div class="col-md-9 text-right _buttons proposal_buttons">
                ...
                <a href="<?php echo admin_url(SAM_MODULE.'/proposals/proposal/' . $proposal->id .'/'. $proposal->sam_id); ?>" data-placement="left"
                ...
                <div class="btn-group ">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li>
                            <a
                                href="<?php echo admin_url(SAM_MODULE.'/proposals/send_expiry_reminder/' . $proposal->id); ?>"><?php echo _l('send_expiry_reminder'); ?></a>
                        </li>
                        <?php } ?>
                        <li>
                        ...
                        <li>
                            <a
                                href="<?php echo admin_url() . SAM_MODULE. '/proposals/copy/' . $proposal->id .'/'. $proposal->sam_id; ?>"><?php echo _l('proposal_copy'); ?></a>
                        </li>
                        <?php } ?>
                        ...
                        <li>
                            <a
                                href="<?php echo admin_url() . SAM_MODULE. '/proposals/mark_action_status/' . $status . '/' . $proposal->id; ?>"><?php echo e(_l('proposal_mark_as', format_proposal_status($status, '', false))); ?></a>
                        </li>
                        <?php
                     }
                                }
                        ...
                        <li>
                            <a href="<?php echo admin_url(SAM_MODULE.'/proposals/clear_signature/' . $proposal->id); ?>"
                                class="_delete">
                        ...
                        <li>
                            <a href="<?php echo admin_url() . SAM_MODULE.'/proposals/delete/' . $proposal->id .'/'. $proposal->sam_id; ?>"
                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-success dropdown-toggle<?php if ($proposal->status!=3) {
                                echo ' disabled';
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                     ...
                     ?>
                        ...
                        <li <?php if ($disable_convert) {
                         ...
                         echo 'data-template="contract" onclick="proposal_convert_template(this); return false;"';
                     } ?>><?php echo "Contract";//_l('proposal_convert_estimate'); ?></a></li>
                        <?php } ?> 
                    </ul>
                </div>
                <?php } ?>
                    ...
                    <div role="tabpanel" class="tab-pane active" id="tab_proposal">
                     ...
                     if ($proposal->project_id) { ?>
                            ...
                            <div class="col-md-6">
                              ...
                              ?>
                                    <a href="<?php echo admin_url(SAM_MODULE.'/proposals/proposal/' . $proposal->id .'/'. $proposal->sam_id); ?>">
                                ...
                                <h5 class="bold mbot15 font-medium"><a
                                        href="<?php echo admin_url(SAM_MODULE.'/proposals/proposal/' . $proposal->id .'/'. $proposal->sam_id); ?>"><?php echo e($proposal->subject); ?></a>
                                </h5>
...
<?php $this->load->view(SAM_MODULE.'/proposals/send_proposal_to_email_template'); ?>
<script>
...
sam_id = '<?php echo e($proposal->sam_id); ?>';
...
function proposal_convert_template(e) {
    ...
    requestGet("<?=SAM_MODULE?>/proposals/get_" + t + "_convert_data/" + proposal_id + '/' + sam_id).done((function(e) {
