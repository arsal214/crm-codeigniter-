...
<div class="panel-body">
    <div class="row">
        <div class="col-md-4">
            <?php $this->load->view(SAM_MODULE.'/proposals/item_select'); ?>
        </div>
            ...
            <tbody>
                ...
                <?php if (isset($estimate) || isset($add_items)) {
                         ...
                         foreach ($add_items as $item) {
                             ...
                             $table_row .= '<td class="taxrate">' . $this->sam_proposals_model->get_taxes_dropdown_template('' . $items_indicator . '[' . $i . '][taxname][]', $estimate_item_taxes, (isset($is_proposal) ? 'proposal' : 'estimate'), $item['id'], true, $manual) . '</td>';
