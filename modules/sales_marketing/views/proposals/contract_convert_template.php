...
<div class="modal fade proposal-convert-modal" id="convert_to_contract" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <?php echo form_open(SAM_MODULE.'/proposals/convert_to_contract/' . $p_id .'/'. $sam_id, ['id' => 'proposal_convert_to_contract_form', 'class' => '_transaction_form contract-form']); ?>
        <input type="hidden" class="" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" onclick="close_modal_manually('#convert_to_contract')" aria-label="Close">
                ...
                <div class="row">
                    <div class="col-md-12">         
                        ...
                        <div class="form-group" app-field-wrapper="subject">
                            ...
                            <input type="text" id="subject" name="subject" class="form-control" value="<?=$p_subject?>">
                        </div>                        
                        <div class="form-group">
