    ...
    <div class="panel-body form-horizontal">
        <div class="col-md-12 notice-details-margin">
            <div class="col-sm-4 text-right">
                <label class="control-label"><strong><?= _l('sam_meeting_format') ?> :</strong></label>
            </div>
            <div class="col-sm-8">
                <p class="form-control-static">
                <?php 
                    $format = array(_l('sam_meeting_online'),_l('sam_meeting_inperson'));
                    if(isset($format[$details->format])){
                        echo $format[$details->format];
                    } 
                    else{
                        echo "";
                    }
            ...
            <div class="col-sm-8">
                <p class="form-control-static"><?php
                    if (!empty($details->user_id)) {
                        echo sam_fullname($details->user_id);
                    }
                    ?></p>
            </div>
        </div>
