...
<?php if(!isset($sam_id)){ $sam_id = $this->uri->segment(4); } ?>
<div class="modal fade" id="TemplateModal">
    <div class="modal-dialog modal-xxl" role="document">
        <div class="modal-content">
            ...
            <?php
            if (!isset($template)) {
                echo form_open('admin/'.SAM_MODULE.'/templates/template/0/'.$sam_id, ['id' => 'template-form']);
            } else {
                echo form_open('admin/'.SAM_MODULE.'/templates/template/' . $id .'/'.$sam_id, ['id' => 'template-form']);
            }
            ?>
