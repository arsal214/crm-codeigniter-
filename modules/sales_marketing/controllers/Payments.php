...
class Payments extends AdminController
{
    ...
    public function batch_payment_modal() {
        ...
        $this->load->view(SAM_MODULE.'/payments/batch_payment_modal', $data);
    }
    ...
    public function add_batch_payment()
    {
        ...
        if ($totalAdded > 0) {
            ...
            return redirect(admin_url(SAM_MODULE.'/payments'));
        }
        return redirect(admin_url(SAM_MODULE.'/invoices'));
    }
    ...
    public function list_payments()
    {
        ...
        $this->load->view(SAM_MODULE.'/payments/manage', $data);
    }
    ...
    public function payment($id = '')
    {
        ...
        $this->load->view(SAM_MODULE.'/payments/payment', $data);
    }
