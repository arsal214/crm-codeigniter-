...
class Credit_notes extends AdminController
{
    ...
    public function list_credit_notes($id = '')
    {
        ...
        $this->load->view(SAM_MODULE.'/credit_notes/manage', $data);
    }
    ...
    public function credit_note($id = '')
    {
        ...
        if ($this->input->post()) {
            ...
            if ($id == '') {
                ...
                if ($id) {
                    ...
                    redirect(admin_url(SAM_MODULE.'/credit_notes/list_credit_notes/' . $id));
                }
            } else {
        ...
        $this->load->view(SAM_MODULE.'/credit_notes/credit_note', $data);
    }
    ...
    public function apply_credits_to_invoices($credit_note_id)
    {
        ...
        redirect(admin_url(SAM_MODULE.'/credit_notes/list_credit_notes/' . $credit_note_id));
    }
    ...
    public function credit_note_from_invoice($invoice_id)
    {
        if (staff_can('create',  'credit_notes')) {
            ...
            if ($id) {
                redirect(admin_url(SAM_MODULE.'/credit_notes/credit_note/' . $id));
            }
        }
    ...
    public function refund($id, $refund_id = null)
    {
        if (staff_can('edit',  'credit_notes')) {
            ...
            $this->load->view(SAM_MODULE.'/credit_notes/refund', $data);
        }
    }
    ...
    public function edit_refund($refund_id, $cerdit_note_id)
    {
        ...
        redirect(admin_url(SAM_MODULE.'/credit_notes/list_credit_notes/' . $cerdit_note_id));
    }
    ...
    public function get_credit_note_data_ajax($id)
    {
        ...
        $this->load->view(SAM_MODULE.'/credit_notes/credit_note_preview_template', $data);
    }
    ...
    public function delete_invoice_applied_credit($id, $credit_id, $invoice_id)
    {
        ...
        redirect(admin_url(SAM_MODULE.'/invoices/list_invoices/' . $invoice_id));
    }
    ...
    public function delete_credit_note_applied_credit($id, $credit_id, $invoice_id)
    {
        ...
        redirect(admin_url(SAM_MODULE.'/credit_notes/list_credit_notes/' . $credit_id));
    }
    ...
    public function delete($id)
    {
        ...
        if (!$id) {
            redirect(admin_url(SAM_MODULE.'/credit_notes'));
        }
    ...
    public function pdf($id)
    {
        ...
        if (!$id) {
            redirect(admin_url(SAM_MODULE.'/credit_notes/list_credit_notes'));
        }
        $credit_note        = $this->credit_notes_model->get($id);
