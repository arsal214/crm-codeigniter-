...
class Templates extends AdminController
{
    ...
    public function modal()
    {
        ...
        $data['sam_id'] = $this->input->post('sam_id');
        //print_r($_POST); exit;
        ...
        $this->load->view(SAM_MODULE.'/template', $data);
    }
    ...
    public function index($id = null)
    {
        ...
        $this->load->view(SAM_MODULE.'/templates', $data);
    }
     ...
     *
     */
    public function template($id = null,$sam_id='')
    {
        ...
        redirect(
            $data['type'] == 'contracts' ?
            admin_url(SAM_MODULE.'/contracts/contract/' . $rel_id.'/'.$sam_id) :
            admin_url(SAM_MODULE.'/proposals#' . $rel_id)
        );
    }
