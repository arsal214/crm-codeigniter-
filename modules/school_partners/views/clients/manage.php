        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="_buttons">
                    ...
                    <a href="<?php echo $this->uri->segment(2) == 'clients' ? admin_url('clients/client') : admin_url('clients/client').'?type=sp'; ?>"
                        class="btn btn-primary mright5 test pull-left display-block">
                        <i class="fa-regular fa-plus tw-mr-1"></i>
                        <?php echo $this->uri->segment(2) == 'clients' ? _l('new_client') : 'New School Partner' ; ?>
                    </a>
                                ...
                                <div
                                    ...
                                    <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                                       <?php if($this->uri->segment(2) == 'clients'){
                                           echo total_rows(db_prefix() . 'clients', ($where_summary != '' ? substr($where_summary, 5) : ''));
                                       } else{
                                           echo total_rows(db_prefix() . 'school_partners', ($where_summary != '' ? substr($where_summary, 5) : ''));
                                       } ?>
                                    </span>
                                    <span
                                        class="text-dark tw-truncate sm:tw-text-clip"><?php echo $this->uri->segment(2) == 'clients' ? _l('customers_summary_total') : 'Total School Partners'; ?></span>
                                </div>
                                <div
                                    class="md:tw-border-r md:tw-border-solid md:tw-border-neutral-300 tw-flex-1 tw-flex tw-items-center">
                                    <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                                         <?php if($this->uri->segment(2) == 'clients'){
                                             echo total_rows(db_prefix() . 'clients', 'active=1' . $where_summary);
                                         } else{
                                             echo total_rows(db_prefix() . 'school_partners', 'active=1' . $where_summary);
                                         } ?>
                                    </span>
                                    <span
                                        class="text-success tw-truncate sm:tw-text-clip"><?php echo $this->uri->segment(2) == 'clients' ?_l('active_customers') : 'Active School Partners'; ?></span>
                                </div>
                                <div
                                    class="md:tw-border-r md:tw-border-solid md:tw-border-neutral-300 tw-flex-1 tw-flex tw-items-center">
                                    <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                                        <?php if($this->uri->segment(2) == 'clients'){
                                            echo total_rows(db_prefix() . 'clients', 'active=0' . $where_summary);
                                        } else{
                                            echo total_rows(db_prefix() . 'school_partners', 'active=0' . $where_summary);
                                        } ?>
                                    </span>
                                    <span
                                        class="text-danger tw-truncate sm:tw-text-clip"><?php echo $this->uri->segment(2) == 'clients' ? _l('inactive_active_customers') : 'InActive School Partners'; ?></span>
                                </div>
                                <div
                                    class="md:tw-border-r md:tw-border-solid md:tw-border-neutral-300 tw-flex-1 tw-flex tw-items-center">
                                    <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
...
$(function() {
    ...
    var last_part = parts[parts.length-1];
        ...
        var tAPI = initDataTable('.table-clients', admin_url + 'school_partners/table', [0], [0], CustomersServerParams,
