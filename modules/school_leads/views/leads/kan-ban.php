...
foreach ($statuses as $status) {
    ...
    $kanBan = new \app\services\leads\SchoolLeadsKanban($status['id']);
            ...
            <div class="kan-ban-content-wrapper">
                ...
                foreach ($leads as $lead) {
                    ...
                    echo ' disabled';
                                ...
                                onclick="kanban_load_more(<?php echo $status['id']; ?>, this, 'school_leads/leads_kanban_load_more', 315, 360); return false;"
                                ;>
