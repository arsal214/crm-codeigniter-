        ...
        <div class="row">
            <div class="col-md-12">
                <div class="_buttons tw-mb-2 sm:tw-mb-4">
                    <a href="#" onclick="init_school_lead(); return false;"
                        class="btn btn-primary mright5 pull-left display-block">
                        <i class="fa-regular fa-plus tw-mr-1"></i>

                        <?php echo $this->uri->segment(2) == 'leads' ? _l('new_lead') : 'New School Lead' ; ?>
                    </a>
                    ...
                    <div class="row">
                        <div class="col-sm-5 ">
                            ...
                            <a href="<?php echo admin_url('school_leads/switch_kanban/' . $switch_kanban); ?>"
                              ...
                              $table_data = hooks()->apply_filters('leads_table_columns', $table_data);
                               ?>
                                    <div class="panel-table-full">
                                        <?php
                                 render_school_leads_datatable(
                                   $table_data,
                                   'school-leads',
                                   ['customizable-table number-index-2'],
                                   [
                                    'id'                         => 'table-school-leads',
...
<?php init_tail(); ?>
<script src="<?php echo module_dir_url('school_leads','assets/js/school_leads.js'); ?>"></script>
<script>
