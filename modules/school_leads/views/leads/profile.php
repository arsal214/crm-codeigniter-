...
<div class="<?php if ($openEdit == true) {
    ...
    <?php
           ...
           if (total_rows(db_prefix() . 'contacts', ['email' => $lead->email]) > 0 && total_rows(db_prefix() . 'clients', ['leadid' => $lead->id]) == 0) {
               ...
               $text = isset($_GET['type']) ? "Covert to School Partner" : _l('lead_convert_to_client');
    ...
    <?php } ?>
    <?php echo form_open((isset($lead) ? admin_url('school_leads/lead/' . $lead->id) : admin_url('school_leads/lead')), ['id' => 'lead_form']); ?>
    <div class="row">
          ...
          ?>
            ...
            <div class="col-md-12">
                <div class="form-group no-mbot" id="inputTagsWrapper">
                    ...
                    <input type="hidden" value="<?php echo isset($action_url)  ? $action_url : '' ?>" name="school_table">
                    <?php } ?>
                </div>
            </div>
            <div class="clearfix"></div>
