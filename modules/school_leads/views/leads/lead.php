    ...
    echo ' lead-new';
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="gdpr">
                  ...
                  ?>
                    <a href="<?php echo admin_url('school_leads/export/' . $lead->id); ?>">
                ...
                <div role="tabpanel" class="tab-pane" id="attachments">
                    <?php echo form_open('admin/school_leads/add_lead_attachment', ['class' => 'dropzone mtop15 mbot15', 'id' => 'lead-attachment-upload']); ?>
                    <?php echo form_close(); ?>
                    <?php if (get_option('dropbox_app_key') != '') { ?>
                    <hr />
                    <div class=" pull-left">
                        <?php if (count($lead->attachments) > 0) { ?>
                        <a href="<?php echo admin_url('school_leads/download_files/' . $lead->id); ?>" class="bold">
                ...
                <div role="tabpanel" class="tab-pane" id="lead_notes">
                    <?php echo form_open(admin_url('school_leads/add_note/' . $lead->id), ['id' => 'lead-notes']); ?>
