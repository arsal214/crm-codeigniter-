                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="tw-flex tw-items-center tw-space-x-3">
                                            ...
                                            <a href="<?php echo admin_url('school_leads/delete_status/' . $status['id']).(($status['type'] == null) ? "" : "?type=sl"); ?>"
...
<?php include_once(FCPATH . 'modules/school_leads/views/leads/status.php'); ?>
<?php init_tail(); ?>
</body>
